...
function Input_Decimal(dot) {
    // this ensures tha accidental clicking of the decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    //then updates the operatorand exist from the function
    ...
    } else if (operator) {//checkif an operaotr already exist
